...
# Storage Class
curl -s -u EmilOvcina:$1 https://api.github.com/repos/DM885/RabbitMQK8S/contents/rabbitmq-statefulset-sc.yaml |jq -r ".content" |base64 --decode | kubectl apply -f -

# # NAMESPACES
kubectl create ns rabbits

# MYSQL
curl -s -u EmilOvcina:$1 https://api.github.com/repos/DM885/MySQLK8S/contents/mysql-secrets.yaml |jq -r ".content" |base64 --decode | kubectl apply -f -
curl -s -u EmilOvcina:$1 https://api.github.com/repos/DM885/MySQLK8S/contents/mysql-secrets.yaml |jq -r ".content" |base64 --decode | kubectl -n rabbits apply -f -
